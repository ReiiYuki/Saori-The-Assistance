...
public class Calculator extends JFrame {
		...
		textFieldInput.addKeyListener(new KeyListener(){
			public void keyPressed(KeyEvent evt) {
				...
				if(key == KeyEvent.VK_9 || key == KeyEvent.VK_NUMPAD9){
					...
					//textFieldInput.setText(textFieldInput.getText().substring(textFieldInput.getText().length()-1));
				}
	...
	private void memoryreadActionPerformed(ActionEvent evt) {//GEN-FIRST:event_memoryreadActionPerformed
		textFieldInput.setText(String.valueOf(textFieldShow.getText()));
	...
	private void memorysaveActionPerformed(ActionEvent evt) {//GEN-FIRST:event_memorysaveActionPerformed
		textFieldShow.setText(String.valueOf(textFieldInput.getText()));
